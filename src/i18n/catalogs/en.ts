export const en = {
  ...
  subscription: {
    ...
    redeemCode: {
      title: 'Redeem Code',
      subtitle: 'Enter your promo or access code below',
      ...
      errorAlreadyRedeemed: 'This code has already been redeemed.',
      errorOverLimit: 'This code has reached its redemption limit.',
      errorPlatformUnavailable: 'This code is not available on this platform.',
      acceptedTitle: 'Code Accepted',
      confirmedTitle: 'Lifetime Access Active',
      freeLifetimeAccess: 'FREE Lifetime Access',
      discountedAccess: 'Discounted Lifetime Access',
      discountPrice: 'Price after discount: {{price}}',
      ...
      redeemFreeAccess: 'Redeem Free Access',
      redeemDiscountedAccess: 'Continue to Purchase',
      redeemDiscountedAccessWithPrice: 'Continue to Purchase - {{price}}',
      tryDifferentCode: 'Try a different code',
      syncing: 'Syncing access...',
      syncAccess: 'Sync Access',
      restorePurchases: 'Restore Purchases',
      ...
      applyFailed: 'We could not apply this code. Please try again.',
      done: 'Done',
    },
  },
} as const
