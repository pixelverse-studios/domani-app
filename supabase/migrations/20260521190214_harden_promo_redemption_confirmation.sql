-- Replace client-callable promo confirmation with a service-only confirmation
-- function that can be called by RevenueCat webhook/server-side purchase sync.
